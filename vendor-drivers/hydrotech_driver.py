...
Vendor: HydroTech
Category: hydro (Solar / Wind / Hydro / Storage / EV)
Protocol: ModbusTCP (ModbusTCP / ModbusRTU / CANbus / REST_API / S7comm)
"""
...
class CustomVendorDriver:
    def __init__(self, host="127.0.0.1", port=502, unit_id=1):
        self.vendor_name = "HydroTech"
        self.category = "hydro"
        self.protocol = "ModbusTCP"
        self.host = host
        self.port = port
